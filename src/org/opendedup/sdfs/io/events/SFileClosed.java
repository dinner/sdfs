...
public class SFileClosed  extends GenericEvent{
	public SparseDedupFile sf = null;
	long location = -1;

	public SFileClosed(SparseDedupFile f) {
		this.sf = f;
	}
	
	public SFileClosed(SparseDedupFile f,long location) {
		this.sf = f;
	...
	public String toJSON() {
		...
		dataset.addProperty("actionType", "sfileClosed");
