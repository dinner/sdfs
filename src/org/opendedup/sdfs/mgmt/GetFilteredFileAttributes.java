...
public class GetFilteredFileAttributes {
	...
	public Element getResult(String cmd, String file, boolean includeFiles,
			boolean includeFolders, int level) throws IOException {
		this.level = level;
	...
	private Element traverse(Document doc, Element parentEl, File parentFile)
			throws DOMException, ParserConfigurationException, IOException {
